...
module.exports = {
    OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '9179994718298' : process.env.OWNER_NUMBER, //ADD YOUR NUMBER
    SESSION_ID: process.env.SESSION_ID === undefined ? 'PRRiSQxC#u5t1g0RXF24CGYGpKAia9qh6DHNIbSHGT-BnjrSllEk' : process.env.SESSION_ID, //ADD YOUR SSION ID
